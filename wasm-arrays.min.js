window.ccallArrays = (func, returnType, paramTypes, params, {heapIn="HEAPF32", heapOut="HEAPF32", returnArraySize=1, resultArray}={}) => {
  ...
  if (returnType=="array") {
    for (let v=0; v<returnArraySize; v++) {
      resultArray[v] = Module[heapOut][res/heapMap[heapOut].BYTES_PER_ELEMENT+v];
    }
  } else {
    return res
  }
