const hotkeysListEntries = [
  ...
  {
    hotkey: '1-9',
    description: 'Spawn N invisible "heavy particles" that all particles will fly towards. All heavy particles will be located in the corners of a perfect N-shaped polygon. For example, pressing 4 will create a "square" at the center of the screen'
  },
  {
    hotkey: 'd',
  ...
  {
    hotkey: 'c',
    description: 'For the duration of the keypress drag all particles on the screen towards the center of the screen'
  },
  {
    hotkey: 'LMB',
    description: '(Left mouse button). Drags all particles towards the cursor for the duration of click'
  },
  {
    hotkey: 'p',
...
window.addEventListener('load', () => {
  ...
  cheatsheet.classList.add('cheatsheet');
